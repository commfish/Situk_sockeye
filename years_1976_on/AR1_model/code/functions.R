...
profile <-function(i,z,xa.start, xa.end,lnalpha.c, lnalpha, beta1, coda){
 ...
 yield <- cbind(of_0.7,oy_0.7,or_0.7,of_0.8,oy_0.8,or_0.8,of_0.9,oy_0.9,or_0.9, c(0, x))
  ...
  write.csv(qm,("years_1976_on/AR1_model/output/processed/QM.csv"), row.names=FALSE)
  write.csv(yield,("years_1976_on/AR1_model/output/processed/yield.csv"), row.names=FALSE)
  ...
  write.csv(CI,("years_1976_on/AR1_model/output/processed/CI_median.csv"), row.names=FALSE)
  ...
  CI <- spread(CI, measure, value)
  CI <- CI[c("q95", "q90", "Median","q10", "q5", "Escapement")]
  write.csv(CI,("years_1976_on/AR1_model/output/processed/CI_mean.csv"), row.names=FALSE)
  
  
  # yield data
  read.csv("years_1976_on/AR1_model/output/processed/yield.csv") -> yield 
  ...
  write.csv(., file= "years_1976_on/AR1_model/output/processed/optimal_yield_data.csv")}
