...
read.csv("years_1988_on/basic_Ricker_model/output/processed/recruit_data.csv") -> recruit
...
QM <- read.csv("years_1988_on/basic_Ricker_model/output/processed/QM.csv")
CI_median <- read.csv("years_1988_on/basic_Ricker_model/output/processed/CI_median.csv")
CI_mean <- read.csv("years_1988_on/basic_Ricker_model/output/processed/CI_mean.csv")
...
ggplot(data = CI_median, aes(x = Escapement, y = Median)) +
  ...
  geom_text(size=3, data=spawnrecruitdat, aes(x=spawn, y=recruit50, label = year,family="Times",
                                             hjust = -0.1, vjust= -0.4))
ggsave("years_1988_on/basic_Ricker_model/output/processed/horsetail.png", dpi = 500, height = 6, width = 8, units = "in")
...
ggsave("years_1988_on/basic_Ricker_model/output/processed/horsetail_historic.png", dpi = 500, height = 6, width = 8, units = "in")
...
ggsave("years_1988_on/basic_Ricker_model/output/processed/expected_yield.png", dpi = 500, height = 6, width = 8, units = "in")

# yield profiles 
read.csv("years_1988_on/basic_Ricker_model/output/processed/optimal_yield_data.csv") %>%
...
ggsave("years_1988_on/basic_Ricker_model/output/processed/yield_profiles.png", dpi = 500, height = 7, width = 6, units = "in")

# residual plot 
tickryr <- data.frame(Year = 1988:2020)
xaxis <- fngr::tickr(tickryr, Year, 4)
recruit <- read.csv("years_1988_on/basic_Ricker_model/output/processed/recruit_data.csv") %>%
...
ggsave("years_1988_on/basic_Ricker_model/output/processed/resids_recruit.png", dpi = 500, height = 7, width = 8, units = "in")

# create optimal yield plot
read.csv("years_1988_on/basic_Ricker_model/output/processed/yield.csv") -> df
